      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-xl w-full max-h-[95vh] overflow-y-auto">
        ...
        <div className="p-3 space-y-2">
          <div className="p-2 bg-gray-50 rounded-lg">
            ...
            {sellerShippingFee > 0 && (
              <div className="flex justify-between">
                <span className="text-gray-600">Frais de livraison (vendeur):</span>
        ...
        <div className="p-1.5 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-[10px] text-blue-800">
            Paiement Stripe Connect sécurisé. Le vendeur expédie directement et reçoit le paiement sous 1-3 jours.
          </p>
        </div>
