export const fr = {
  ...
  auth: {
    ...
    createAccount: 'Créez votre compte vendeur ou acheteur',
    emailSent: 'Email envoyé !',
    resetLinkSent: 'Nous avons envoyé un lien de réinitialisation à',
    checkInbox: 'Vérifiez votre boîte de réception et cliquez sur le lien pour réinitialiser votre mot de passe. Le lien expire dans 1 heure.',
  ...
  landing: {
    ...
    buyersFee: 'Acheteurs : 10% de commission',
    ...
    feature1Desc: 'Vendez vos cheveux facilement. Recevez vos paiements directement.',
    feature2Title: 'Frais transparents',
    feature2Desc: 'Seulement 10% de commission pour les acheteurs. Pas de frais cachés.',
